    ...
    void AidMan::run()
    {
        ...
        do {
            ...
            if (select == 1) {
                ...
                cout << "\n****Ship Items****" << endl;
                ofstream fship("shippingOrder.txt");
                fship << "Shipping Order, Date: " << Date() << endl;
                fship << " ROW |  SKU  | Description                         | Have | Need |  Price  | Expiry" << endl;
                fship << "-----+-------+-------------------------------------+------+------+---------+-----------" << endl;
                int numShipped = 0;
                for (int i = 0; i < m_numProducts; i++) {
                    if (m_products[i]->qty() == m_products[i]->qtyNeeded()) {
                        m_products[i]->linear(true);
                        fship.width(3);
                        fship.setf(ios::right);
                        fship.fill(' ');
                        fship << ' ' << numShipped + 1 << " | ";
                        fship.unsetf(ios::right);
                        fship << *m_products[i] << endl;
                        remove(i);
                        i--;
                        numShipped++;
                    }
                ...
                fship << "-----+-------+-------------------------------------+------+------+---------+-----------" << endl;
                cout << "Shipping Order for " << numShipped << " times saved!\n" << endl;
            }
            else if (select == 7) {
